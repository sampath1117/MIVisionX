...
public:
    ...
    FloatParam *area_factor, FloatParam *aspect_ratio, FloatParam *x_drift, FloatParam *y_drift, RocalBatchPolicy last_batch_policy = RocalBatchPolicy::BATCH_FILL, bool last_batch_padded = false);
