...
def audio(*inputs, file_root='', file_list_path = '', bytes_per_sample_hint=[0], shard_id = 0, num_shards = 1, random_shuffle = False, downmix=False, dtype=types.FLOAT, preserve=False, quality=50.0, max_frames=1 , max_channels=1 ,sample_rate=0.0, seed=1, storage_type=9, stick_to_shard=False, shard_size=-1, resample=False, start_sample_rate_range=0.85, end_sample_rate_range=1.15):
    kwargs_pybind = {
            "source_path": file_root,
            ...
            "resample":resample,
            "start_sample_rate_range":start_sample_rate_range,
            "end_sample_rate_range":end_sample_rate_range
            }
